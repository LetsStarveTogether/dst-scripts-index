...
#### `0x42012110` `dst-scripts/entityscript.lua`
...
#### `0x42013110` `SetBrain` 到 `_Start_Internal`
...
#### `0x42013210` `BrainWrangler:Update`
...
#### `0x42013310` `_Stop_Internal`、`Pause`、`Resume`
...
### `0x42014100` Brain 对象字段

#### `0x42014110` `Brain = Class(...)`
...
### `0x42014200` Behaviour Tree 接口

#### `0x42014210` `Brain:OnUpdate`
