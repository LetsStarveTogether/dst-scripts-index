...
#### `0x31022110` `dst-scripts/entityscript.lua`
...
### `0x31024100` 数据结构与生命周期

#### `0x31024110` 具体 Lua 结构
...
##### `0x31024141` Source 与 Listener 双向索引
...
##### `0x31024151` `OnRemoveFromEntity` 与 `OnRemoveEntity`
...
##### `0x31024161` `standardcomponents.lua`
