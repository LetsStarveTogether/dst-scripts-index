...
### `0x32021100` 要回答的运行时问题

#### `0x32021110` 候选动作如何被提交
...
### `0x32021200` 与 `pre_action_cb` 的边界

#### `0x32021210` 回调不在 `BufferedAction:Do` 中触发
...
#### `0x32022110` `dst-scripts/entityscript.lua`
...
#### `0x32022120` `dst-scripts/bufferedaction.lua`
...
#### `0x32023210` `PerformBufferedAction`
...
### `0x32024200` Success/fail 回调

#### `0x32024210` `AddSuccessAction` 与 `AddFailAction`
...
#### `0x32024310` `PreviewAction` 与 `PerformPreviewBufferedAction`
