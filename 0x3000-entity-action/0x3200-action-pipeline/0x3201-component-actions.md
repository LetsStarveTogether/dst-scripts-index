...
#### `0x32012110` `dst-scripts/components/playeractionpicker.lua`
...
#### `0x32012120` `dst-scripts/componentactions.lua`
...
#### `0x32013120` `GetLeftClickActions`
...
#### `0x32013130` `GetRightClickActions`
...
#### `0x32013210` `EntityScript:CollectActions`
...
### `0x32014100` `COMPONENT_ACTIONS` 表

#### `0x32014110` 原生组件 Collector
...
### `0x32014200` `ACTION_COMPONENT_NAMES` 与实体组件
...
### `0x32014500` Mod 注册与网络同步

#### `0x32014510` `AddComponentAction`
...
### `0x32014600` 客户端请求动作上下文

#### `0x32014610` `CLIENT_REQUESTED_ACTION`
