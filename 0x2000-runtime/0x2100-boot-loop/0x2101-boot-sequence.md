...
#### `0x21012110` `dst-scripts/main.lua`
...
#### `0x21013120` `Start()` 到 `gamelogic.lua`
...
### `0x21014100` 数据结构与生命周期

#### `0x21014110` `Settings.reset_action`
