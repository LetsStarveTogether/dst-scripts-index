...
### `0x51031100` 要回答的运行时问题

#### `0x51031110` Layout 在 Worldgen 中什么时候生效
...
### `0x51032100` Graph Layout

#### `0x51032110` `dst-scripts/map/layout.lua`
...
### `0x51032200` Static Layout

#### `0x51032210` `dst-scripts/map/static_layout.lua`
...
### `0x51032300` Object Layout

#### `0x51032310` `dst-scripts/map/object_layout.lua`
...
### `0x51033100` Set Piece 选择阶段

#### `0x51033110` `worldgen_main.GetRandomFromLayouts`
...
### `0x51033200` Task 分配阶段

#### `0x51033210` `Level:ChooseSetPieces`
...
### `0x51033300` Storygen 标记阶段

#### `0x51033310` `Story:InsertAdditionalSetPieces`
...
#### `0x51033410` `Node:ConvertGround`

##### `0x51033411` `countstaticlayouts`
...
### `0x51034100` Room Contents 与 Static Layout

#### `0x51034110` `countstaticlayouts`
...
### `0x51034200` `object_layout` 数据结构

#### `0x51034210` Layout 定义字段
...
#### `0x51034320` `GetRandomFromLayouts`
