...
### `0x51021100` 要回答的运行时问题

#### `0x51021110` 三层数据各自决定什么
...
### `0x51022100` `Level` 注册与运行时对象

#### `0x51022110` `dst-scripts/map/levels.lua`
...
#### `0x51022120` `dst-scripts/map/level.lua`
...
#### `0x51022130` `dst-scripts/map/tasksets.lua`
...
### `0x51022200` `Task` 与 `Room`

#### `0x51022210` `dst-scripts/map/tasks.lua`
...
#### `0x51022220` `dst-scripts/map/rooms.lua`
...
#### `0x51023310` `Story:GenerateNodesFromTask`
...
### `0x51023400` Story Graph 阶段

#### `0x51023410` `Story:GenerateNodesForRegion`
