...
### `0x72021100` 要回答的运行时问题

#### `0x72021110` 哪些表是静态，哪些表会被翻译或生成
...
### `0x72021200` 展示数据与 Gameplay 状态

#### `0x72021210` 只读展示不等于权威状态
...
#### `0x72022110` `dst-scripts/translator.lua`
...
### `0x72022200` Scrapbook 锚点

#### `0x72022210` `dst-scripts/screens/redux/scrapbookscreen.lua`
...
#### `0x72023110` `Translator:LoadPOFile`
...
### `0x72023300` Scrapbook 展示阶段

#### `0x72023310` `scrapbookdata.lua`
...
### `0x72024100` `TranslateStringTable`

#### `0x72024110` Path 作为翻译 Key
...
### `0x72024200` `ScrapbookScreen`

#### `0x72024210` 数据过滤与 Known Level
