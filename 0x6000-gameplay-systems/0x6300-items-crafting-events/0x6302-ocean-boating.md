...
### `0x63021100` 要回答的运行时问题

#### `0x63021110` 船如何承载玩家和物品
...
### `0x63021200` 与世界模拟页的边界

#### `0x63021210` 本页只追实体和组件

##### `0x63021211` 不展开 Map/ocean 生成
...
#### `0x63022110` `dst-scripts/prefabs/boat.lua`
...
#### `0x63022210` `walkableplatform` 与 `walkableplatformplayer`
...
#### `0x63023210` `AddPlatformFollower`
