...
### `0x62022110` 主锚点 / `dst-scripts/actions.lua`
...
### `0x62022120` 主锚点 / `dst-scripts/components/eater.lua`
...
### `0x62022130` 主锚点 / `dst-scripts/components/edible.lua`
...
### `0x62022140` 主锚点 / `dst-scripts/components/hunger.lua`
...
### `0x62022150` 主锚点 / `dst-scripts/components/sanity.lua`
...
### `0x62022160` 主锚点 / `dst-scripts/components/farmplantable.lua`
...
### `0x62022170` 主锚点 / `dst-scripts/components/farmplanttendable.lua`
